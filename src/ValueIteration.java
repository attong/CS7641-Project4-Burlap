//taken from https://github.com/jmacglashan/burlap/blob/master/src/main/java/burlap/behavior/singleagent/planning/stochastic/valueiteration/ValueIteration.java
//adapted for easy data collection
...
public class ValueIteration extends DynamicProgramming implements Planner {
	 ...
	 */
	public ValueIteration(SADomain domain, double gamma, HashableStateFactory hashingFactory, double maxDelta, int maxIterations,String filnam){
	...
	public int getConvergenceIterations() {
		return this.convergenceIterations;
	}
	/**
	 ...
	 * @throws IOException 
	 */
	public void runVI() throws IOException{
